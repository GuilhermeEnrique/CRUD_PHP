...
<head>
    ...
    <!-- SCRIPT BOOTSTRAP E DATABLES -->
    <script src="https://code.jquery.com/jquery-3.5.1.js"></script>
    <script src="https://cdn.datatables.net/1.12.1/js/jquery.dataTables.min.js"></script>
    <script src="https://cdn.datatables.net/1.12.1/js/dataTables.bootstrap5.min.js"></script>
    <script src="./js/datables.js" type="text/javascript" language="javascript"></script>
...
<body class="fundo-bd">
    <div class="container-flex mainContainer">
        <div class="row g-3 main-list">
            ...
            <table id="listar-usuario" class="table table-striped align-middle table-bg" style="width: 100%">
                <thead>
                    <tr>
                        <th style="text-align:center;" scope="col">ID</th>
                        <th style="text-align:center;" scope="col">Nome</th>
                        <th style="text-align:center;" scope="col">Sobrenome</th>
                        <th style="text-align:center;" scope="col">Username</th>
                        <th style="text-align:center;" scope="col">E-mail</th>
                        <th style="text-align:center;" scope="col"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear" viewBox="0 0 16 16">
