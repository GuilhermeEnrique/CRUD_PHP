...
while ($row_usuarios = mysqli_fetch_array($resultado_usuarios)) {
    ...
    $dado[] = ' <div style="text-align:center;">
                    ...
                    <a class="btn btn-danger btn-config" href="./delete.php?id=' . $row_usuarios["id"] . '"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-square-fill" viewBox="0 0 16 16">
